...
class ATCChatThreadAdapter: ATCGenericCollectionRowAdapter {
    ...
    func configure(cell: UICollectionViewCell, with object: ATCGenericBaseModel) {
        ...
        let unseenByMe = viewModel.lastMessageSeeners.filter { $0["uid"] == viewer.uid }.isEmpty
        ...
        cell.subtitleLabel.font = unseenByMe ? uiConfig.boldSmallFont : uiConfig.regularSmallFont
        cell.subtitleLabel.textColor = unseenByMe ? uiConfig.mainTextColor : uiConfig.mainSubtextColor
