...
class ATChatMessage: ATCGenericBaseModel, MessageType {
    ...
    init(messageId: String, messageKind: MessageKind, createdAt: Date, atcSender: ATCUser, recipient: ATCUser, lastMessageSeeners: [ATCUser], seenByRecipient: Bool, allTagUsers: [String] = [], inReplyToMessage: String? = nil) {
        self.id = messageId
