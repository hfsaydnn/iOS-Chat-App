...
//    }
    ...
    func decodeFromDict(_ jsonDict: [String: Any]) {
        ...
        self.inboundFriendsCount = jsonDict["inboundFriendsCount"] as? Int
        self.outboundFriendsCount = jsonDict["outboundFriendsCount"] as? Int
    }
    ...
    open override func isEqual(_ object: Any?) -> Bool {
        guard let user = object as? ATCUser else { return false }
